...
@ControllerAdvice
public class ECommerceTryException extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleRegraNegocioException(BusinessException ex, WebRequest request){
